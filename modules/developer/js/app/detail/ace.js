(function() {
    ...
    function s(e) {
        ...
        function h(e) {
            ...
            if (e.y + 3 * t.renderer.lineHeight + 15 < n.bottom) u.style.bottom = "", u.style.top = e.y + 15 + "px";
            else {
                u.style.top = "";
    ...
    (function() {
        ...
        r.implement(this, o), this.setDocument = function(e) {
            ...
            if (typeof Worker != "undefined" && !e.noWorker) try {
                ...
                //console.log("Could not load worker"), console.log(t),
                this.$worker = null
    ...
    (function() {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, d), this.updateCharacterSize = function() {
            ...
            e && (this.$gutterLayer.$padding = null), e ? this.$renderChanges(s, !0) : this.$loop.schedule(s | this.$changes), this.resizing && (this.resizing = 0)
            ...
            return i && this._signal("resize", o), i
            ...
            i.top = e | 0, i.bottom = t | 0, i.right = r | 0, i.left = n | 0, i.v = i.top + i.bottom, i.h = i.left + i.right, this.updateFull()
            ...
            if (!this.$size.width) return this.$changes |= e, this.onResize(!0);
            ...
            if (e & this.CHANGE_SIZE || e & this.CHANGE_LINES) this.$updateScrollBarV(), this.$updateScrollBarH();
            this._signal("afterRender")
            ...
            var y = 0;
            if (a || l) y = this.$updateCachedSize(!0, this.gutterWidth, this.$size.width, this.$size.height), this._signal("scrollbarVisibilityChanged"), l && (o = this.$getLongestLine());
            ...
            function s(r) {
                ...
                n.$padding && s != n.$padding && n.setPadding(s), n.$size && (n.$size.width = 0, n.onResize()), n._dispatchEvent("themeLoaded", {
                    theme: r
                }), t && t()
            }
            var n = this;
            this.$themeValue = e, n._dispatchEvent("themeChange", {
                theme: e
            });
    ...
    (function() {
        i.implement(this, o), this.setSession = function(e) {
            ...
            for (;;) {
                ...
                if (p > n) {
                    while (this.$cells.length > h + 1) c = this.$cells.pop(), this.element.removeChild(c.element);
                    break
                }
                c = this.$cells[++h], c || (c = {
                    element: null,
                ...
                u[p] && (d += u[p]), a[p] && (d += a[p]), this.$annotations[p] && (d += this.$annotations[p].className), c.element.className != d && (c.element.className = d);
                ...
                if (g) {
                    ...
                    g == "start" && p == s && p < i.end.row ? d += " ace_closed" : d += " ace_open", c.foldWidget.className != d && (c.foldWidget.className = d);
            ...
            y += b.left + b.right, y !== this.gutterWidth && !isNaN(y) && (this.gutterWidth = y, this.element.style.width = Math.ceil(this.gutterWidth) + "px", this._emit("changeGutterWidth", y))
    ...
    (function() {
        this.updateSelectionMarkers = function() {
            ...
            if (i.isEmpty()) {
                ...
                i.cursor = e == -1 ? i.start : i.end, this.multiSelect.addRange(i);
                return
            }
